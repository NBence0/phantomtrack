...
<nav class="sidebar glass-effect">
    ...
    <ul class="nav-menu">
        <li <?php if ($current_page == 'dashboard.php') echo 'class="active"'; ?>>
            <a href="<?php echo BASE_URL; ?>admin/dashboard.php" title="Irányítópult"><i class="fas fa-tachometer-alt"></i><span>Irányítópult</span></a>
        </li>
        
        <li <?php if ($current_page == 'files.php') echo 'class="active"'; ?>>
            <a href="<?php echo BASE_URL; ?>admin/files.php" title="Fájlkezelő"><i class="fas fa-folder-open"></i><span>Fájlkezelő</span></a>
        </li>
            ...
            <ul class="submenu">
                ...
                <li <?php if ($current_page == 'file_requests.php') echo 'class="active"'; ?>>
                 ...
                 <li <?php if ($current_page == 'permanent_requests.php') echo 'class="active"'; ?>>
                    <a href="<?php echo BASE_URL; ?>admin/permanent_requests.php" title="Állandó Feltöltő Link"><i class="fas fa-link"></i><span>Állandó Link</span></a>
                </li>
            </ul>
        </li>
        ...
        <li class="<?php if($is_category_section_active) echo 'active '; if (!empty($navCategories)) echo 'has-submenu'; ?>">
            <a href="<?php echo BASE_URL; ?>admin/categories.php" title="Kategóriák kezelése"><i class="fas fa-tags"></i><span>Kategóriák</span></a>
            <?php if (!empty($navCategories)): ?>
                <ul class="submenu">
                    ...
                    <li <?php if ((in_array($current_page, ['tokens.php', 'files.php'])) && $category_id_from_url === null) echo 'class="active"'; ?>>
                        <a href="<?php echo BASE_URL . 'admin/' . ($current_page == 'files.php' ? 'files.php' : 'tokens.php'); ?>" title="Minden elem kategória nélkül">Összes (aktuális nézet)</a>
                    </li>
                    ...
                    <?php foreach ($navCategories as $cat): ?>
                        <li <?php if ($category_id_from_url === $cat['id']) echo 'class="active"'; ?>>
                            ...
                            <a href="<?php echo BASE_URL . 'admin/' . ($current_page == 'files.php' ? 'files.php' : 'tokens.php'); ?>?category_id=<?php echo $cat['id']; ?>"><?php echo escape($cat['name']); ?></a>
                        </li>
                    <?php endforeach; ?>
                </ul>
            <?php endif; ?>
        ...
        <li <?php if ($current_page == 'settings.php') echo 'class="active"'; ?>>
            <a href="<?php echo BASE_URL; ?>admin/settings.php" title="Beállítások"><i class="fas fa-cog"></i><span>Beállítások</span></a>
        </li>
        <?php if (isAdmin()): ?>
            <li <?php if ($current_page == 'users.php') echo 'class="active"'; ?>>
                <a href="<?php echo BASE_URL; ?>admin/users.php" title="Felhasználók"><i class="fas fa-users-cog"></i><span>Felhasználók</span></a>
            </li>
        <?php endif; ?>
    </ul>
    <div class="sidebar-footer">
        <p>Bejelentkezve: <?php echo escape(getCurrentUsername()); ?></p>
        <a href="<?php echo BASE_URL; ?>admin/logout.php" class="btn btn-secondary"><i class="fas fa-sign-out-alt"></i><span>Kijelentkezés</span></a>
    </div>
</nav>